const bodyClass = "bg-white bg-opacity-25";
...
function addClasses(button) {
  ...
  const baseClass =
    "number flex w-12 h-12 justify-center items-center m-1 font-bold py-2 px-2 border hover:border-transparent rounded text-black border-2 text-2xl";
